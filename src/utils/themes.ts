const themes = [
    {
        ...
        secondary: "#CCCCCC",  // Light gray heading
        right: "#00FF00",      // Bright green for correct
        wrong: "#FF0000",      // Bright red for wrong
    },
    {
        name: "ocean-breeze",
    ...
    },
    {
        ...
        primary: "#4A4A4A",    // Dark gray text
        secondary: "#6A4C93",  // Purple heading
        right: "#6A4C93",      // Purple for correct
        wrong: "#FF6F61",      // Coral pink for wrong
    },
    {
        name: "cyberpunk",
