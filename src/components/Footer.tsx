    ...
    <div className="flex flex-col justify-end h-full  mb-3 ">
      <div className="flex justify-between p-4 mx-[20%]">
        ...
        <DropdownMenu>
          ...
          >
            <DropdownMenuLabel style={{ color: currentTheme.primary }}>
              THEMES
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
            {themes.map((theme, index) => {
              return (
                <DropdownMenuItem
                  ref={(element) => (refer.current[index] = element)}
                  onMouseEnter={() => {
                    if (refer.current[index]) {
                      refer.current[index].style.color = 'black';
                    }
                  }}
                  onMouseLeave={() => {
                    if (refer.current[index]) {
                      refer.current[index].style.color = currentTheme.primary;
                    }
                  }}
                  style={{ color: currentTheme.primary }}
                  onClick={() => {
